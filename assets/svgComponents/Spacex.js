...
function Spacex(props) {
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 50" {...props}>
            <Path
                d="M37.5 30.5H10.9v-6.6h34.3c-.9-2.8-3.8-5.4-8.9-5.4H11.4c-5.7 0-9 2.1-9 6.7v4.9c0 4 3.4 6.3 8.4 6.3h26.9v7H1.5c.9 3.8 3.8 5.8 9 5.8h27.1c5.7 0 8.5-2.2 8.5-6.9v-4.9c0-4.3-3.3-6.6-8.6-6.9zM91.8 18.6H59v30.7h9.3V37.5h24.2c6.7 0 10.4-2.3 10.4-7.7v-3.4c-.1-5-4.3-7.8-11.1-7.8zm3 9.8c0 2.2-.4 3.4-4 3.4H68.3l.1-8h22c4 0 4.5 1.2 4.5 3.3v1.3z"
            />
            <Path
            ...
            <G className="letter_e">
                <Path d="M228.3 43.5L228.3 34.1 247 34.1 247 28.9 218.9 28.9 218.9 49.3 260.4 49.3 260.4 43.5z" />
                <Path d="M219.9 18.6H261.8V24H219.9z" />
            </G>
            <Path
